...
var app = (function () {
    ...
    // (41:2) {#each $settings.rollingItems as item, index (item.label)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			toggle_class(div, "active", /*$rolling*/ ctx[1] && /*$activeItem*/ ctx[2] === /*index*/ ctx[6]);
    			add_location(div, file, 41, 4, 873);
    			this.first = div;
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*$settings*/ 1 && t0_value !== (t0_value = /*item*/ ctx[4].label + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*$rolling, $activeItem, $settings*/ 7) {
    				toggle_class(div, "active", /*$rolling*/ ctx[1] && /*$activeItem*/ ctx[2] === /*index*/ ctx[6]);
    			}
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:2) {#each $settings.rollingItems as item, index (item.label)}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 39, 0, 784);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, rolling, $$value => $$invalidate(1, $rolling = $$value));
    	validate_store(activeItem, "activeItem");
    	component_subscribe($$self, activeItem, $$value => $$invalidate(2, $activeItem = $$value));
    	let rollingInterval;
    	...
    	rolling.subscribe(isRolling => {
    		if (isRolling) {
    			rollingInterval = setInterval(
    				() => {
    					const activeIndex = Math.floor(Math.random() * ($settings.rollingItems.length || 0));
    	...
    	return [$settings, $rolling, $activeItem];
    }
